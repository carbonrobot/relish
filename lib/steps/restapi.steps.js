...
module.exports = function () {
    ...
    this.Given(/^the synthetic id from the response$/i, function () {
        assert(this.actualResponse, 'Must make an initial request before using the response.');
        this.syntheticId = _.get(this.actualResponse, 'result.data.syntheticId');
    });
